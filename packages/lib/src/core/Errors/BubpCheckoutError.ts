...
class BubpCheckoutError extends Error {
    ...
    constructor(type: keyof typeof BubpCheckoutError.errorTypes, message?: string, options?: CheckoutErrorOptions) {
        super(message);

        this.name = BubpCheckoutError.errorTypes[type];
        this.options = options || {};
        this.cause = this.options.cause;
    }
}

export default BubpCheckoutError;
