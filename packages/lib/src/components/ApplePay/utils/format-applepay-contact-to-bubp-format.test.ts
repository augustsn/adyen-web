import { formatApplePayContactToBubpAddressFormat } from './format-applepay-contact-to-bubp-format';

describe('formatApplePayContactToBubpAddressFormat()', () => {
    test('should build the street by merging the address lines and set houseNumberOrName to ZZ', () => {
        ...
        const billingAddress = formatApplePayContactToBubpAddressFormat(billingContact);
    ...
    test('should return firstName and lastName if the contact is for delivery address', () => {
        ...
        const deliveryAddress = formatApplePayContactToBubpAddressFormat(deliveryContact, true);
    ...
    test('should return undefined if no contact details is passed', () => {
        ...
        expect(formatApplePayContactToBubpAddressFormat()).toBeUndefined();
    });
});
