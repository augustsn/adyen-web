...
export default function CVCHint({ frontCVC = false, fieldLabel, onClick }: CVCHintProps) {
    const hintClassnames = classNames({
        'bubp-checkout__card__cvc__hint__wrapper': true,
        'bubp-checkout__field__cvc--front-hint': !!frontCVC,
        'bubp-checkout__field__cvc--back-hint': !frontCVC
    });
    ...
    return (
        ...
        <span className={hintClassnames} onClick={onClick}>
            <svg
                className={'bubp-checkout__card__cvc__hint bubp-checkout__card__cvc__hint--front'}
                width="27"
                height="18"
                viewBox="0 0 27 18"
                fill="none"
                ...
                role={'img'}
            >
                <title id={'bubp-checkout__cvc__front-hint-img'}>{fieldLabel}</title>
                <path
                ...
                <rect className={'bubp-checkout__card__cvc__hint__location'} x="16.5" y="4.5" width="7" height="5" rx="2.5" stroke="#C12424" />
            </svg>

            <svg
                className={'bubp-checkout__card__cvc__hint bubp-checkout__card__cvc__hint--back'}
                width="27"
                height="18"
                viewBox="0 0 27 18"
                fill="none"
                ...
                role={'img'}
            >
                <title id={'bubp-checkout__cvc__back-hint-img'}>{fieldLabel}</title>
                <path
                ...
                <path
                    ...
                    fill="white"
                />
                <rect className={'bubp-checkout__card__cvc__hint__location'} x="16.5" y="9.5" width="7" height="5" rx="2.5" stroke="#C12424" />
            </svg>
        </span>
    );
}
