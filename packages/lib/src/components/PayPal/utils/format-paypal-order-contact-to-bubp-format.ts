...
/**
 * This function formats PayPal contact format to BUB Payment address format
 */
export const formatPaypalOrderContactToBubpFormat = (paymentContact: any, isDeliveryAddress?: boolean): AddressData | null => {
