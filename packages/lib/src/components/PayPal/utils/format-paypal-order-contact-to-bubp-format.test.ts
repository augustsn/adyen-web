import { formatPaypalOrderContactToBubpFormat } from './format-paypal-order-contact-to-bubp-format';
...
const paypalAuthorizedEvent: any = {
    ...
    purchase_units: [
        {
            ...
            payee: {
                email_address: 'sell1_1287491142_biz@bubpayment.com',
    ...
    payer: {
        ...
        email_address: 'buy1_1287492020_per@bubpayment.com',
...
describe('formatPaypalOrderContactToBubpFormat', () => {
    test('should format billing address', () => {
        const billingAddress = formatPaypalOrderContactToBubpFormat(paypalAuthorizedEvent.payer, false);
    ...
    test('should format delivery address', () => {
        const deliveryAddress = formatPaypalOrderContactToBubpFormat(paypalAuthorizedEvent.purchase_units?.[0].shipping, true);
    ...
    test('should return null if paypal object is not in the expected format', () => {
        const data = formatPaypalOrderContactToBubpFormat({});
