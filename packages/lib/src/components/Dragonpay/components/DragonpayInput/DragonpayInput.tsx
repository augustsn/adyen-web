...
export default function DragonpayInput(props: DragonpayInputProps) {
    ...
    return (
        <div className="bubp-checkout__dragonpay-input__field">
            <Field
            ...
            >
                <InputEmail
                    ...
                    className={'bubp-checkout__input--large'}
                    spellCheck={false}
            ...
            {isIssuerRequired() && (
                <Field label={i18n.get(getIssuerSelectFieldKey(props.type))} errorMessage={!!errors.issuer} name={'issuer'}>
                    <Select
                        ...
                        name={'issuer'}
                        className={'bubp-checkout__dropdown--large bubp-checkout__issuer-list__dropdown'}
